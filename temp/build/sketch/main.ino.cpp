#include <Arduino.h>
#line 1 "C:\\Users\\Daniel\\Documents\\GitHub\\con-cho\\main\\main.ino"
#include <Wire.h>
...
#line 18 "C:\\Users\\Daniel\\Documents\\GitHub\\con-cho\\main\\main.ino"
void setup();
#line 53 "C:\\Users\\Daniel\\Documents\\GitHub\\con-cho\\main\\main.ino"
void loop();
#line 116 "C:\\Users\\Daniel\\Documents\\GitHub\\con-cho\\main\\main.ino"
...
void setup() {
    ...
    // initial state
    uint16_t pulse = map(98, 0, 180, SERVOMIN, SERVOMAX);
    pwm.setPWM(0, 0, pulse);
    pulse = map(94, 0, 180, SERVOMIN, SERVOMAX);
    pwm.setPWM(8, 0, pulse);
    pulse = map(85, 0, 180, SERVOMIN, SERVOMAX);
    pwm.setPWM(12, 0, pulse);
    pulse = map(82, 0, 180, SERVOMIN, SERVOMAX);
...
void moveLeg(float x, float y, int shoulder, int knee) {
    ...
    if (sqrt(x*x+y*y) >= 84) {
        uint16_t pulse1 = map(0, 0, 180, SERVOMIN, SERVOMAX);
        uint16_t pulse2 = map(0, 0, 180, SERVOMIN, SERVOMAX);
